{
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "df_app = pd.read_csv('D:/Ti/Cursos/Vscode/github/portfolio/ciencia-de-dados/google-play/googleplaystore.csv')"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "outputs": [
        {
          "data": {
            "image/png": "",
            "text/plain": [
              "<Figure size 1080x504 with 1 Axes>"
            ]
          },
    ...
    },
    {
      ...
      "outputs": [
        {
          "data": {
            "image/png": "",
            "text/plain": [
              "<Figure size 864x576 with 1 Axes>"
            ]
          },
    ...
    },
    {
      ...
      "outputs": [
        {
          "data": {
            "image/png": "",
            "text/plain": [
              "<Figure size 864x576 with 1 Axes>"
            ]
          },
    ...
    },
    {
      ...
      "outputs": [
        {
          "data": {
            "image/png": "",
            "text/plain": [
    ...
    },
    {
      ...
      "outputs": [
        {
          "data": {
            "image/png": "",
            "text/plain": [
              "<Figure size 1080x504 with 1 Axes>"
            ]
          },
  ...
  "metadata": {
    ...
    "vscode": {
      "interpreter": {
        "hash": "46c4a2612cfa5c085643e8ff4a63fb85f591cfea033fa9bdad2c8a43fa2d3ca4"
      }
    }
  },
  "nbformat": 4,
